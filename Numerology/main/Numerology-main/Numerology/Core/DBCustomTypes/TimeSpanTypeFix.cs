...
namespace Core.DBCustomTypes
{
    ...
    /// </summary>
    [Serializable]
	public partial class TimeSpanTypeFix : PrimitiveType, IVersionType
	{
		/// <summary>
		/// Default constructor.
		/// </summary>
		public TimeSpanTypeFix() : base(SqlTypeFactory.GetTime(0))
		{
		}
		...
		public TimeSpanTypeFix(TimeSqlType sqlType) : base(sqlType)
		{
		}
		...
		public override void Set(DbCommand st, object value, int index, ISessionImplementor session)
		{
			...
			else
			{
				...
				st.Parameters[index].Value = ((TimeSpan)value).ToString(@"hh\:mm");
			}
		}
